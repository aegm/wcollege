...
<link media="all" 
href="Tradukka%20_%20Translation%20in%20real%20time_files/hi.css" 
						...
						if(isset($_POST['aceptar2']) && $_POST['aceptar2'])
						{
								...
								if (isset($usuario) && $usuario['contrato'] && $usuario['activo']<>'n' && $usuario['activo']<>'N' )
								{
									...
									{	
										?>
										<script type="text/javascript">
											showLightbox();<!--********************ventana de registro (div)******************-->
...
<title>Washinton English College-<?php if (isset($leccionT))
									   { 
