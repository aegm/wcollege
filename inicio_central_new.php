                ...
                <div class="carousel-inner">
                    <div class="item active"> 
                        <div class="col-md-6 news-item">
                            <h2 class="title"><a href="news-single.html">Educación Online y Movil</a></h2>
                            <p>A las universidades, institutos tecnológicos y escuelas de formación profesional de la región les urge actualizar su metodología..</p>
                        ...
                        <div class="col-md-6 news-item">
                            <h2 class="title"><a href="news-single.html">Como Funciona</a></h2>
