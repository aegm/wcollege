...
<div class="input_text">
    ...
    <div class="formulario_interno" style="text-align:left"><?php if ($usuario['nivel'] == 'p') {
    echo ('Profesor');
} else {
    if ($usuario['nivel'] == 'E') {
        echo ('Estudiante');
...
<div class="input_text">
    ...
    <div class="formulario_interno" style="text-align:left"><?php if ($usuario['activo'] == 'S' || $usuario['activo'] == 's') {
    echo ('Activo');
} else {
    if (!isset($s)) {
        echo ('Inactivo');
...
<div class="input_text">
    ...
    <div class="formulario_interno" style="text-align:left"><?php if ($usuario2['email2']) echo $usuario2['email2'];
    else echo 'N/A'; ?></div></div> 
<div class="input_text">
    <div class="formulario_interno"><strong>E-mail recomendado 3:&nbsp;</strong></div> 
    <div class="formulario_interno" style="text-align:left"><?php if ($usuario2['email2']) echo $usuario2['email3'];
    else echo 'N/A'; ?></div></div> 
<div class="input_text">
