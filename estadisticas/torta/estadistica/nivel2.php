...
$_SESSION['cantidad_nivel2'] = $cantidad2;
?>
<table width="629" height="88" border="0" align="center" cellpadding="1" cellspacing="1"  >
    ...
    <tr  > 
        <td width="51" height="58" align="right" valign="middle"> 
            <div align="center"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif" class="letra"><b><?php echo "Nivel 2"; ?></b></font></div></td>
